...
public class TrackerSQLTest {
    ...
    public void testDML() throws Exception {
        try (TrackerSQL sql = new TrackerSQL(ConnectionRollback.create(this.init()))) {
            ...
            Item item = new Item("name1", "desc1", new Timestamp(System.currentTimeMillis()));
            item = sql.add(item);
            Item item2 = new Item("name2", "desc2", new Timestamp(System.currentTimeMillis()));
            item2 = sql.add(item2);
            Item item3 = new Item("name3", "desc3", new Timestamp(System.currentTimeMillis()));
            item3 = sql.add(item3);
            ...
            Item item4 = new Item(sql.getCurrentValue() + 1, "name4", "desc4", new Timestamp(System.currentTimeMillis()));
            ...
            Item item5 = new Item(sql.getCurrentValue() + 1, "name5", "desc5", new Timestamp(System.currentTimeMillis()));
