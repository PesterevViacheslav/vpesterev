...
/**
 * Class Chess - Шахматы. Решение задачи Части 002. ООП. Задача 8.1 Каркас шахматной доски.
 *
...
public class Chess extends Application {
    ...
    /**
     * Method buildRectangle. Отрисовка клетки.
     * @param x Координата x.
     * @param y Координата y.
     * @param size Размер клетки.
     * @param white Цвет клетки.
     * @return Клетка
     */
    ...
    /**
     * Method buildFigure. Отрисовка фигуры.
     * @param x Координата x.
     * @param y Координата y.
     * @param size Размер клетки.
    ...
    /**
     * Method buildGrid. Отрисовка Сетки.
     */
    ...
    /**
     * Method start. Запуск приложения.
     */
    @Override
    ...
    /**
     * Method refresh. Обновление доски.
     */
    ...
    /**
     * Method buildBlackTeam. Добавление черных фигур на доску.
     */
    ...
    /**
     * Method buildWhiteTeam. Добавление белых фигур на доску.
     */
    ...
    /**
     * Method findBy. Поиск ячейки по координатам.
